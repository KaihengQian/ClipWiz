...
class DanmuHighlights(object):
    ...
    def video_play(self):
        ...
        time.sleep(0.5)  # 必须添加此行代码，等待视频加载完成
...
video_url = "https://www.bilibili.com/video/BV18N411c7Yw/?spm_id_from=333.999.0.0&vd_source=6331d32848604442bd474cf0a0456e94"
highlights_play(time_list_path, video_url)
