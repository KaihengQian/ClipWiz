...
# 计算块的最终得分
soccer_other_helper_functions.score_calculate(block_audio_info_path, weight_1, weight_2)
...
# 应用评估函数对准确率进行评价
# soccer_evaluation_functions.evaluation_function(input_video_path, time_list_path, event_path, story_path,
