...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "D:/Pycharm/pythonProject/project/dataset/soccer_seg_detection/test_before"
    dir_save_path = "D:/Pycharm/pythonProject/project/pics"
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        while True:
            ...
            img = "D:/Pycharm/pythonProject/project/pics/17.jpg"
            try:
                ...
                # r_image = np.int8(r_image)
                r_image.show()
                # cv2.imwrite(, r_image)
                # r_image.save("D:/Pycharm/pythonProject/project/pics/12_mask.jpg")
                break
